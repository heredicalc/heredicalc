...
class CI5IXHBOPCTraitMapper:
    """Maps CI5-IX trait codes and affection codes to HBOPC canonical phenotypes."""

    meta = PluginMeta(
        name="ci5_ix_hbopc",
        version="1.0.0",
        kind="trait_mapper",
        description="Maps CI5-IX trait codes to HBOPC canonical phenotypes",
        author="HerediCalc",
