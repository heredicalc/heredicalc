"""CI5-XII + HBOPC+PrCa trait mapper."""
...
class CI5XIIHBOPCPrCaTraitMapper:
    """Maps CI5-XII trait codes and affection codes to HBOPC+PrCa canonical phenotypes."""

    meta = PluginMeta(
        name="ci5_xii_hbopc_prca",
        version="1.0.0",
        kind="trait_mapper",
        description="Maps CI5-XII trait codes to HBOPC+PrCa canonical phenotypes",
        author="HerediCalc",
