...
class CI5XIHBOPCTraitMapper:
    """Maps CI5-XI trait codes and affection codes to HBOPC canonical phenotypes."""

    meta = PluginMeta(
        name="ci5_xi_hbopc",
        version="1.0.0",
        kind="trait_mapper",
        description="Maps CI5-XI trait codes to HBOPC canonical phenotypes",
        author="HerediCalc",
