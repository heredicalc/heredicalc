...
class CI5XHBOPCPrCaTraitMapper:
    """Maps CI5-X trait codes and affection codes to HBOPC+PrCa canonical phenotypes."""

    meta = PluginMeta(
        name="ci5_x_hbopc_prca",
        version="1.0.0",
        kind="trait_mapper",
        description="Maps CI5-X trait codes to HBOPC+PrCa canonical phenotypes",
        author="HerediCalc",
        min_api_version="1.0.0",
        compatible_with={
            "incidence_source": ["ci5_x"],
