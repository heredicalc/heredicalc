"""CI5-XI + HBOPC+PrCa trait mapper."""
...
class CI5XIHBOPCPrCaTraitMapper:
    """Maps CI5-XI trait codes and affection codes to HBOPC+PrCa canonical phenotypes."""

    meta = PluginMeta(
        name="ci5_xi_hbopc_prca",
        version="1.0.0",
        kind="trait_mapper",
        description="Maps CI5-XI trait codes to HBOPC+PrCa canonical phenotypes",
        author="HerediCalc",
        min_api_version="1.0.0",
        compatible_with={
            "incidence_source": ["ci5_xi"],
