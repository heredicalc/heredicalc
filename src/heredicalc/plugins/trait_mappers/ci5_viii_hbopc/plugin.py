...
class CI5VIIIHBOPCTraitMapper:
    """Maps CI5-VIII trait codes and affection codes to HBOPC canonical phenotypes."""

    meta = PluginMeta(
        name="ci5_viii_hbopc",
        version="1.0.0",
        kind="trait_mapper",
        description="Maps CI5-VIII trait codes to HBOPC canonical phenotypes",
        author="HerediCalc",
