...
class CI5XHBOPCTraitMapper:
    """Maps CI5-X trait codes and affection codes to HBOPC canonical phenotypes."""

    meta = PluginMeta(
        name="ci5_x_hbopc",
        version="1.0.0",
        kind="trait_mapper",
        description="Maps CI5-X trait codes to HBOPC canonical phenotypes",
        author="HerediCalc",
